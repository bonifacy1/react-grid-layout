...
export function getSameGroupCollision(
  layout: Layout,
  layoutItem: LayoutItem
): boolean {
  return !!layout.find(l => layoutItem.group === l.group);
}
...
export function moveElement(
  ...
  cols: number,
  allowOverlap: ?boolean,
  preventOverlapInGroups: ?boolean
): Layout {
  ...
  if (hasCollisions && allowOverlap) {
    ...
    if (hasSameGroupCollision && preventOverlapInGroups) {
      l.x = oldX;
      l.y = oldY;
      l.moved = false;
      return layout;
